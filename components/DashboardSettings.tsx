  ...
  return (
    <div className="space-y-5">
          ...
          <section className="rounded-xl border border-black/10 bg-white p-5 shadow-[0_14px_35px_rgba(0,0,0,0.04)]">
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm font-medium text-black/55">Update your personal dashboard details.</p>
              </div>
            </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <label className="block">
                ...
                <input className="mt-2 h-11 w-full rounded-lg border border-black/10 px-4 text-sm font-bold text-black outline-none" defaultValue="Temiloluwa" />
              </label>
              <label className="block">
                <span className="text-xs font-black uppercase text-black/45">Email</span>
                <input className="mt-2 h-11 w-full rounded-lg border border-black/10 px-4 text-sm font-bold text-black outline-none" defaultValue="temiloluwa@example.com" />
              </label>
              <label className="block">
                <span className="text-xs font-black uppercase text-black/45">Phone</span>
                <input className="mt-2 h-11 w-full rounded-lg border border-black/10 px-4 text-sm font-bold text-black outline-none" defaultValue="+234 801 234 5678" />
              </label>
              <label className="block md:col-span-2">
                <span className="text-xs font-black uppercase text-black/45">Primary Address</span>
                <textarea
                  className="mt-2 min-h-24 w-full resize-none rounded-lg border border-black/10 px-4 py-3 text-sm font-bold leading-6 text-black outline-none"
                  defaultValue="18 Admiralty Way, Lekki Phase 1, Lagos"
                />
              </label>
            </div>
          </section>
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:justify-end">
        ...
        <button className="flex h-11 items-center justify-center gap-2 rounded-lg bg-[#f10606] px-5 text-sm font-black text-white shadow-[0_12px_24px_rgba(241,6,6,0.18)]" type="button">
          <Save size={16} />
          Save Settings
        </button>
      </div>
